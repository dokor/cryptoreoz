package crypto.webservices.internal;
...
import crypto.services.configuration.ConfigurationService;
...
public class SwaggerWs {
	...
	public SwaggerWs(ConfigurationService configurationService) {
		...
		beanConfig.setResourcePackage("crypto.webservices.api");
		beanConfig.setBasePath("/api");
		beanConfig.setTitle("API crypto");
